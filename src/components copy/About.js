      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            At resQ, our mission is to save lives and provide swift and effective relief during natural and man-made disasters. We are committed to coordinating rescue agencies, deploying vital resources, and fostering resilience within communities, all in pursuit of a safer, more prepared world.
            </p>
