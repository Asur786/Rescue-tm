  ...
  return (
    <div className="flex justify-between p-5 bg-blue-900 text-white items-center">
      <div className='flex gap-4 items-center'>
        <h1 className='text-2xl font-semibold text-red-300 cursor-pointer'><Link to="/">RESQ</Link></h1>
        ...
        <ul className="cursor-pointer hover:text-red-400"><Link to="/Login">Login</Link></ul>
